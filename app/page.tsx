...
<nav className="fixed top-0 z-50 w-full bg-white/80 backdrop-blur-md">
  ...
  {/* MOBILE MENU */}
  {menuOpen && (
    <div className="flex flex-col gap-4 bg-white px-6 pb-6 pt-2 text-sm font-medium shadow-md md:hidden">

      <a
  href="/"
  onClick={() => setMenuOpen(false)}
  className="hover:text-[#F25555]"
>
        Home
      </a>

      <a href="/services" className="hover:text-[#F25555]">
        Services
      </a>

      <a href="/portfolio" className="hover:text-[#F25555]">
        Portofolio
      </a>

      <a href="/contact" className="hover:text-[#F25555]">
        Contact
      </a>
      ...
      <a
        href="https://wa.me/6285175459050"
        target="_blank"
        className="rounded-full bg-[#F25555] px-6 py-3 text-center text-white"
      >
        Konsultasi Gratis
      </a>
...
<div className="max-w-xl text-center md:text-left">
  ...
  width={700}
  height={900}
  className="mx-auto w-full max-w-md rounded-[32px] animate-float md:max-w-full"
/>
